...
public class DeclaracaoArquivoFonteMaisDeUmaClasseValida {
	...
	public static void main(String[] args) {
		...
		DeclaracaoDeOutraClasseNaoPublicDentroDoMesmoArquivo outraDeclaracao = new DeclaracaoDeOutraClasseNaoPublicDentroDoMesmoArquivo();
...
class DeclaracaoDeOutraClasseNaoPublicDentroDoMesmoArquivo {
	private int idade;
